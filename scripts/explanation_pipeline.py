...
def run_explanation_pipeline(args, explainer_configurations = {
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--root', required=True, help='root directory of multiple dataset folders')
    parser.add_argument('-e', '--eval-instead', action='store_true', help='evaluate explainers instead')
