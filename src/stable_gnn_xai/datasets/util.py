...
def write_graph_iterable(graphs: Iterable[Data], destination: Path, seed, test_fraction, val_fraction, overwrite=False):
...
def attribute_split_to_graph_list(graphs: Iterable[Data], seed, test_fraction, val_fraction):
